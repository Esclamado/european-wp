...
<div class="BS_guest_author_container <?php if ( BS_is_gutenberg() ): echo "gutenberg-style"; endif ?>">
    <div class="tabs">
        ...
        <label class="tab-control-controller" for="author_is_user"><?php echo $translations->translate('User'); ?></label>
        ...
        <label class="tab-control-controller" for="author_is_guest"><?php _e('Guest', 'guest-author'); ?></label>
            ...
            <div id="author_is_user_tab" class="tab">
                    ...
                    if (BS_is_gutenberg ()) {
                      ?>
                        ...
                        <p><?php _e('Go to', 'guest-author') ?> <b>"<?php echo $translations->translate('Status & Visibility'); ?>"</b></p>
